			...
			echo'<ul class="nav navbar-nav navbar-header">';
				echo'<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><img src="../img/fox.png" alt="navbar" /><span class="caret"></span></a>';
					echo'<ul class="dropdown-menu">';
						...
						echo'<li><a href="sonnwendfest.php"><h4>Sonnwendfest 2015</h4></a></li>';
						echo'<li><a href="kontakt.php"><h4>Kontakt</h4></a></li>';
						echo'<li><a href="impressum.php"><h4>Impressum</h4></a></li>';
						echo'<li><a href="../desktop.php"><h4>Desktop</h4></a></li>';
					echo'</ul>';
				echo'</li>';
			echo'</ul>';
		echo'</div>';
