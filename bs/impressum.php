...
?>
	...
	<div class="col-md-8">
		...
		<adress>
		<p>
			Christoph Sauer <br> Rodheimerstra&szlig;e 28<br> 35444
			Biebertal <br>
		</p>
		...
		<p>
			<strong>Kontakt:</strong> <br> <a href="tel:+491718686473">Telefon:
				0171-8686473</a><br>
				E-Mail: <a href='mailto:kassenwart@bs.fellingshausen.de'>kassenwart@bs.fellingshausen.de</a></br>
		</p>
		</adress>
		<p>
			...
			<br> Unser Angebot enth&auml;lt Links zu externen Webseiten
			...
			durch Dritte ist nicht m&ouml;glich. <br> Der Nutzung von im
			Rahmen der Impressumspflicht ver&ouml;ffentlichten Kontaktdaten durch
			Dritte zur &uuml;bersendung von nicht ausdr&uuml;cklich angeforderter
			...
			<br> Diese Website benutzt Google Analytics, einen
			...
			durch Sie erm&ouml;glicht. Die durch den Cookie erzeugten
			...
			Daten der Google in Verbindung bringen. Sie k&ouml;nnen die
			...
			dieser Website voll umf&auml;nglich nutzen k&ouml;nnen. Durch die
			...
			verwendet sog. ''Cookies'' (Textdateien), die auf Ihrem Computer
			gespeichert werden und die eine Analyse der Benutzung der Website
			durch Sie erm&ouml;glicht. Google Adsense verwendet auch sog. ''Web
			...
			Beacon erzeugten Informationen &uuml;ber Ihre Benutzung diese Website
			(einschlie&szlig;lich Ihrer IP-Adresse) werden an einen Server von
			Google in den USA &uuml;bertragen und dort gespeichert. Google wird
			diese Informationen benutzen, um Ihre Nutzung der Website im Hinblick
			auf die Anzeigen auszuwerten, um Reports &uuml;ber die
			...
			Browser-Einstellungen ''keine Cookies akzeptieren'' w&auml;hlen (Im
		...
		<br> Website Impressum erstellt durch <a
			href="http://www.impressum-generator.de">impressum-generator.de</a>
